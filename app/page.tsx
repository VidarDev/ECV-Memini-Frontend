  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={
            'app-min-h-card relative mt-4 flex aspect-video max-h-20 w-full flex-wrap gap-4 overflow-hidden rounded-2xl bg-theme-neutral-background p-4'
          }
        >
          <Link
          ...
          >
            ...
            <div className={'z-10 flex h-full w-full flex-1 items-end p-4'}>
              <span
                className={`bg-theme-primary-400 inline-flex min-h-10 w-fit items-center gap-2 rounded-full px-6 font-raleway text-sm font-bold text-theme-neutral-invert`}
              >
